...
<head>
  ...
  <!-- Config Tailwind dark mode dan warna tambahan -->
  <script>
    tailwind.config = {
      darkMode: 'class',
      theme: {
...
<body class="transition-all duration-300 bg-sky-100 text-gray-900 dark:bg-gray-900 dark:text-gray-200 font-sans">
  ...
  <!-- About Content -->
  <main class="max-w-3xl mx-auto p-6 mt-8 bg-white dark:bg-gray-800 rounded-2xl shadow-md">
    <h2 class="text-xl font-bold mb-4 text-sky-800 dark:text-sky-400">Tentang Saya</h2>
